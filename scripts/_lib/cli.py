"""scripts/_lib/cli.py — shared scaffolding for the `radian-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("radian-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/radian-foo`
...
VERSION = "0.1.0"  # bumped centrally; every radian-* CLI reports this
