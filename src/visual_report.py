...
<div class="hero">
  <div class="hero-label">Radian &mdash; Deep Research Report</div>
  <h1>{question_html}</h1>
</div>
...
<div class="report-footer">
  Generated by Radian Deep Research &middot; {timestamp}
</div>
  ...
  if (chatBtn) {{
    chatBtn.addEventListener('click', function() {{
      ...
      fetch('/api/research/spinoff/' + encodeURIComponent(researchId), {{
        ...
        // original Radian tab, navigate it and close this report tab so the
