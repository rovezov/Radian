...
INTERNAL_TOOL_TOKEN = os.environ.get("RADIAN_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Radian-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Radian-Internal-Token), or
