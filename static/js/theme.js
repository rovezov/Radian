...
const LS_KEY = 'radian-theme';
const CUSTOM_THEMES_KEY = 'radian-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Radian Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'radian_' + (obj.name || 'theme') + '.json';
      a.click();
