...
function initMermaid() {
  if (!window.mermaid || window.__radianMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__radianMermaidReady = true;
}
window.radianInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'radian-thinking-expanded';
