...
const COLLAPSE_KEY = 'radian-models-collapsed';
const FAVORITES_KEY = 'radian-model-favorites';
const USAGE_KEY = 'radian-model-usage';
const SORT_KEY = 'radian-model-sort';
