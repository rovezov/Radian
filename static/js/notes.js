...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('radian-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'radian-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'radian-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'radian-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'radian-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'radian-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'radian-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('radian-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'radian-note-draft-';
